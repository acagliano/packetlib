...
{\em device} & Specifies the type of device to use. Use the values from {\bfseries{enum}} {\bfseries{\+\_\+device\+\_\+types}}. \\
\hline
{\em buf} & Pointer to the device reference structure. (Ex\+: {\itshape srl\+\_\+device\+\_\+t$\ast$} for serial) \\
\hline
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
Because the header contains a size word, there is no need to pass a read size. The protocol will alternate between attempting to read a {\bfseries{size\+\_\+t}} (3 bytes) and attempting to read the length the last size\+\_\+t indicated. 
\end{DoxyNote}
